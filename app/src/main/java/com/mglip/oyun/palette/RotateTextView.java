 ...
 *         Created by shianqi on 2016/12/3
 */
public class RotateTextView extends TextView{
    ...
    public RotateTextView(Context context, AttributeSet attrs) {
        ...
        translateY = attrs.getAttributeFloatValue(NAME_SPACE, ATTR_TRANSLATE_Y, DEFAULT_VALUE_TRANSLATE_Y);
    }
    @Override
    protected void onDraw(Canvas canvas) {
        canvas.translate(getTextSize(), getMeasuredHeight()*translateY);
        //首先偏移在旋转，是因为，如果先旋转，本身zxy坐标系也会跟着旋转，之后在偏移会不方便我们的控制，也不直观
